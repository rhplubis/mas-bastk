...
public class DisCekBastkListActivity extends AppCompatActivity implements AdapterView.OnItemClickListener {
    Toolbar toolbar;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_dis_cek_bastk_list);
...
//                loading.dismiss();
            ...
            protected String doInBackground(Void... params) {
                ...
                hashMap.put(configuration.KEY_FLAG,"1");
    ...
    private void showDetail(String json){
        ...
        if (code.equals("200")) {
            ...
            Toast.makeText(DisCekBastkListActivity.this,message,Toast.LENGTH_SHORT).show();

            Intent intent = new Intent(DisCekBastkListActivity.this, LoginActivity.class);
