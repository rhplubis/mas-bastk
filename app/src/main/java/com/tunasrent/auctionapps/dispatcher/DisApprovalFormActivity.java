...
public class DisApprovalFormActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_dis_approval_form);
        ...
        btnNext.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(vhc_cat_name.equals("MTR")) {
                    Intent i = new Intent(DisApprovalFormActivity.this, DisApprovalCeklistMotorActivity.class);
                    Bundle b = new Bundle();
                    ...
                    Intent i = new Intent(DisApprovalFormActivity.this, DisApprovalCeklistActivity.class);
                    Bundle b = new Bundle();
    ...
    private void getBastk(){
        class GetBastk extends AsyncTask<Void,Void,String> {
            ...
            protected void onPreExecute() {
                super.onPreExecute();
                loading = ProgressDialog.show(DisApprovalFormActivity.this,"","Loading...",false,false);
            }
            @Override
