...
import com.tunasrent.auctionapps.model.DispatcherlistAdapter;
...
public class DisApprovalListActivity extends AppCompatActivity implements AdapterView.OnItemClickListener {
    Toolbar toolbar;
    ...
    private ArrayList<Dispatcherlist> item_list = new ArrayList<>();
    private DispatcherlistAdapter mAdapter;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_dis_approval_list);
...
//                loading.dismiss();
            ...
            protected String doInBackground(Void... params) {
                ...
                hashMap.put(configuration.KEY_PARENT,"5");
    ...
    private void showDetail(String json){
        ...
        if (code.equals("200")) {
            for (int i=0;i < result.length(); i++) {
                ...
                Dispatcherlist dispatcherlist = new Dispatcherlist(vhcdate,vhcid,vhctype,vendor,status);
                item_list.add(dispatcherlist);
                ...
                mAdapter = new DispatcherlistAdapter(item_list);
            ...
            Toast.makeText(DisApprovalListActivity.this,message,Toast.LENGTH_SHORT).show();

            Intent intent = new Intent(DisApprovalListActivity.this, LoginActivity.class);
...
//                return true;
                ...
                ArrayList<Dispatcherlist> newList  = new ArrayList<>();
                for (Dispatcherlist dispatcherlist : item_list){
                    String name = dispatcherlist.getNopol().toLowerCase();
                    String type = dispatcherlist.getVendor().toLowerCase();
                    if (name.contains(newText)) {
                        newList.add(dispatcherlist);
