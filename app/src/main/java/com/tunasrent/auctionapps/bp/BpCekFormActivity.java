...
import com.tunasrent.auctionapps.ProfileActivity;
...
public class BpCekFormActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_bp_cek_form);

        toolbar = (Toolbar) findViewById(R.id.toolbar);
        setSupportActionBar(toolbar);
        getSupportActionBar().setDisplayHomeAsUpEnabled(true);
        getSupportActionBar().setTitle("Verifikasi Data Unit");
        ...
        scParent = findViewById(R.id.parent_sv);
//        scChild = findViewById(R.id.child_sv);
...
//        scChild.setOnScrollChangeListener(new View.OnScrollChangeListener() {
//            @Override
//            public void onScrollChange(View v, int scrollX, int scrollY, int oldScrollX, int oldScrollY) {
//                scParent.scrollTo(scChild.getScrollX(),scChild.getScrollY());
//            }
//        });
...
//        scParent.setOnScrollChangeListener(new View.OnScrollChangeListener() {
//            @Override
//            public void onScrollChange(View v, int scrollX, int scrollY, int oldScrollX, int oldScrollY) {
//                //scChild.scrollTo(scParent.getScrollX(),scParent.getScrollY());
//
//            }
//        });
//        Toast.makeText(BpCekFormActivity.this,"Form BP Show",Toast.LENGTH_LONG).show();
        getBastk();

        btnNext.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Log.d("YourTag", "Value of etTypeunit: " + vhc_cat_name);
                if(vhc_cat_name.equals("MTR")) {
//                    Intent i = new Intent(BpCekFormActivity.this, BpCekFotoActivity.class);
                    Intent i = new Intent(BpCekFormActivity.this, BpCekCeklistMotorActivity.class);
                    Bundle b = new Bundle();
                    ...
                    b.putString("note_picpenyimpanan", var_notepicpenyimpanan);
...
//                Intent i = new Intent(BpCekFormActivity.this,BpCekCeklistActivity.class);
                    Intent i = new Intent(BpCekFormActivity.this, BpCekFotoActivity.class);
                    Bundle b = new Bundle();
...
//                b.putInt("velg_fisikkanan", var_cbKnalpot2_fisikblkg);
    ...
    private void getBastk(){
        class GetBastk extends AsyncTask<Void,Void,String> {
            ...
            protected void onPreExecute() {
                super.onPreExecute();
                loading = ProgressDialog.show(BpCekFormActivity.this,"","Loading...",false,false);
            }
            @Override
    ...
    private void showData(String json){
        try {
            ...
            vhc_stnk = user.getString(configuration.KEY_STNK);
...
////
            ...
            var_notepicpenyimpanan = user.getString(configuration.KEY_note_picPenyimpanan);
...
//            Toast.makeText(BpCekFormActivity.this,var_picPenyimpanan,Toast.LENGTH_LONG).show();
