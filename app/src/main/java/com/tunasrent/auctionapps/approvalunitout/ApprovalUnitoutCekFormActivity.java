...
import com.tunasrent.auctionapps.unitout.UnitoutCekCeklistActivity;
import com.tunasrent.auctionapps.approvalunitout.ApprovalUnitoutCekCeklistActivity;
import com.tunasrent.auctionapps.unitout.UnitoutCekCeklistMotorActivity;
...
public class ApprovalUnitoutCekFormActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_approvalunitout_cek_form);
        ...
        btnNext.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(vhc_cat_name.equals("MTR")) {
                    Intent i = new Intent(ApprovalUnitoutCekFormActivity.this, UnitoutCekCeklistMotorActivity.class);
                    Bundle b = new Bundle();
                    ...
                    b.putString("url_out_ktp", var_img1);
                    b.putString("url_out_unit_driver", var_img2);
                    b.putString("url_out_gatepass", var_img3);
                    b.putString("url_reason_file", var_img4);
                    ...
                    Intent i = new Intent(ApprovalUnitoutCekFormActivity.this, ApprovalUnitoutCekCeklistActivity.class);
                    Bundle b = new Bundle();
    ...
    private void getBastk(){
        class GetBastk extends AsyncTask<Void,Void,String> {
            ...
            protected void onPreExecute() {
                super.onPreExecute();
                loading = ProgressDialog.show(ApprovalUnitoutCekFormActivity.this,"","Loading...",false,false);
            }
            @Override
            ...
            protected String doInBackground(Void... params) {
                ...
                Log.wtf("nopol yang dikirim = ", nopol);

                String s = rh.sendPostRequest(configuration.URL_DETAIL_APPROVAL_BASTK,hashMap);
                Log.wtf("kirim bastk detail", s);
                return s;
            }
        }
...
////
            ...
            var_img1 = user.getString(configuration.KEY_img_unitout_ktp);
            var_img2 = user.getString(configuration.KEY_img_unitout_unit_driver);
            var_img3 = user.getString(configuration.KEY_img_unitout_gatepass);
            var_img4 = user.getString(configuration.KEY_img_unitout_reason_file);
