...
//import com.tunasrent.auctionapps.unitout.UnitoutReasonReturnActivity;
import com.tunasrent.auctionapps.approvalunitout.ApprovalUnitoutReasonReturnActivity;
import com.tunasrent.auctionapps.util.UserSessionManager;
import com.tunasrent.auctionapps.util.configuration;

import java.util.HashMap;

public class ApprovalUnitoutCekCeklistActivity extends AppCompatActivity {
    Toolbar toolbar;
    Button btnNext;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //setContentView(R.layout.activity_taksasi_cek_ceklist);
        setContentView(R.layout.activity_unitout_cek_ceklist);
...
//            var_etStnk = b.getString("stnk_lain");
            if(b.getString("stnk_lain") == null || b.getString("stnk_lain").equals("null")){
                var_etStnk = "0000-00-00";
            }else{
                var_etStnk = b.getString("stnk_lain");
            }

            if (var_etStnk != null && !var_etStnk.isEmpty()) {
               //Log.d("Debug", "var_etStnk value: " + var_etStnk);
                stnk = var_etStnk.split("-");
            } else {
                //Log.e("Error", "var_etStnk is null or empty");
                showAlert("STNK tidak ditemukan!");
                stnk = new String[0];
                //showAlertAndRedirect("STNK tidak ditemukan! Kembali ke halaman utama.");
            }
            //stnk = var_etStnk.split("-");
            ...
            if (var_etBukukir != null && !var_etBukukir.isEmpty()) {
                //Log.d("Debug", "var_etBukukir value: " + var_etBukukir);
                bukukir = var_etBukukir.split("-");
            } else {
                //Log.e("Error", "var_etBukukir is null or empty");
                showAlert("Buku KIR tidak ditemukan!");
                bukukir = new String[0];
                //showAlertAndRedirect("Buku Kir tidak ditemukan! Kembali ke halaman utama.");
            }
           ...
           // bukukir = var_etBukukir.split("-");
            ...
            if (var_etTrayek != null && !var_etTrayek.isEmpty()) {
                //Log.d("Debug", "var_etTrayek value: " + var_etTrayek);
                trayek = var_etTrayek.split("-");
            } else {
               // Log.e("Error", "var_etTrayek is null or empty");
                showAlert("Ijin Trayek tidak ditemukan!");
                trayek = new String[0];
                //showAlertAndRedirect("Trayek tidak ditemukan! Kembali ke halaman utama.");
            }
            ...
            if (var_etUsaha != null && !var_etUsaha.isEmpty()) {
               // Log.d("Debug", "var_etUsaha value: " + var_etUsaha);
                usaha = var_etUsaha.split("-");
            } else {
               // Log.e("Error", "var_etUsaha is null or empty");
                showAlert("Ijin Usaha tidak ditemukan!");
                usaha = new String[0];
                //showAlertAndRedirect("Usaha tidak ditemukan! Kembali ke halaman utama.");
            }
            //usaha = var_etUsaha.split("-");
...
//            Toast.makeText(TaksasiCekCeklistActivity.this,var_picPenyimpanan,Toast.LENGTH_SHORT).show();
            ...
            var_img1= b.getString("url_out_ktp");
            var_img2= b.getString("url_out_unit_driver");
            var_img3= b.getString("url_out_gatepass");
            var_img4= b.getString("url_reason_file");
            nopol = b.getString("nopol");
            status_unit = b.getString("status_unit");
            Log.d("Debug", "status_unit value: " + status_unit);
        }
...
//        cbDopBlk2_fisikkanan.setText((var_cbDop2_fisikkiri == true) ? "Baik" : "Rusak");
        ...
        if (stnk != null && stnk.length >= 3) {
            etSd_stnk.setText(stnk[2] + "-" + stnk[1] + "-" + stnk[0]);
        } else {
            //showAlertAndRedirect("Data stnk tidak lengkap! Kembali ke halaman utama.");
            etSd_stnk.setText("");
        }
        ...
        if (bukukir != null && bukukir.length >= 3) {
            etSd_bukukir.setText(bukukir[2] + "-" + bukukir[1] + "-" + bukukir[0]);
        } else {
            //showAlertAndRedirect("Data stnk tidak lengkap! Kembali ke halaman utama.");
            etSd_bukukir.setText("");
        }
        //etSd_bukukir.setText(bukukir[2] + "-" + bukukir[1] + "-" + bukukir[0]);
        ...
        if (trayek != null && trayek.length >= 3) {
            etSd_ijintrayek.setText(trayek[2] + "-" + trayek[1] + "-" + trayek[0]);
        } else {
            //showAlertAndRedirect("Data stnk tidak lengkap! Kembali ke halaman utama.");
            etSd_ijintrayek.setText("");
        }
        //etSd_ijintrayek.setText(trayek[2] + "-" + trayek[1] + "-" + trayek[0]);
        ...
        if (usaha != null && usaha.length >= 3) {
            etSd_ijinusaha.setText(usaha[2] + "-" + usaha[1] + "-" + usaha[0]);
        } else {
            //showAlertAndRedirect("Data usaha tidak lengkap! Kembali ke halaman utama.");
            etSd_ijinusaha.setText("");
        }
        //etSd_ijinusaha.setText(usaha[2] + "-" + usaha[1] + "-" + usaha[0]);
        ...
        btnNext.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View v){
                Intent i = new Intent(ApprovalUnitoutCekCeklistActivity.this, ApprovalUnitoutReasonReturnActivity.class);
                Bundle b = new Bundle();
                b.putString("nopol",nopol);
                b.putString("status_unit", status_unit);
                ...
                Log.wtf("gambar ktp = ", var_img1);
                Log.wtf("gambar unit = ", var_img2);
                Log.wtf("gambar gatepass = ", var_img3);
                Log.wtf("gambar file reason = ", var_img4);
                Log.wtf("reason nya =", status_unit);
                i.putExtras(b);
                startActivity(i);
        ...
        /*btnNext.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i = new Intent(UnitoutCekCeklistActivity.this, UnitoutCekFotoActivity.class);
                Bundle b = new Bundle();
    ...
    private void showAlertAndRedirect(String message) {
        new AlertDialog.Builder(ApprovalUnitoutCekCeklistActivity.this)
                .setTitle("Error")
                .setMessage(message)
                ...
                .setPositiveButton("OK", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        Intent intent = new Intent(ApprovalUnitoutCekCeklistActivity.this, MainActivity.class);
