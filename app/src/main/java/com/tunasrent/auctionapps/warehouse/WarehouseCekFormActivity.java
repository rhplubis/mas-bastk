...
public class WarehouseCekFormActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_warehouse_cek_form);
        ...
        btnNext.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(vhc_cat_name.equals("MTR")) {
                    Intent i = new Intent(WarehouseCekFormActivity.this, WarehouseCekCeklistMotorActivity.class);
                    Bundle b = new Bundle();

                    b.putString("vhc_cat_name", vhc_cat_name);
                    b.putInt("cover_kepala1", var_cover_kepala1);
                    b.putInt("cover_kepala2", var_cover_kepala2);
                    ...
                    Intent i = new Intent(WarehouseCekFormActivity.this, WarehouseCekCeklistActivity.class);
                    Bundle b = new Bundle();
                    b.putString("vhc_cat_name", vhc_cat_name);
    ...
    private void getBastk(){
        class GetBastk extends AsyncTask<Void,Void,String> {
            ...
            protected void onPreExecute() {
                super.onPreExecute();
                loading = ProgressDialog.show(WarehouseCekFormActivity.this,"","Loading...",false,false);
            }
            @Override
    ...
    private void showData(String json){
        try {
            ...
            Log.d("JSON Response CARA", "Code: " + code + ", Message: " + result);
                ...
                pool_id = user.getString(configuration.KEY_POOL_ID);
    ...
    ////
                ...
                var_market_price = user.getString(configuration.KEY_MARKET_PRICE);
                var_recomended_price = user.getString(configuration.KEY_REC_PRICE);
                var_repair_machine = user.getString(configuration.KEY_REPAIR_MACHINE);
                var_repair_interior = user.getString(configuration.KEY_REPAIR_INTERIOR);
                var_repair_exterior = user.getString(configuration.KEY_REPAIR_EXTERIOR);
                var_cost_document = user.getString(configuration.KEY_COST_DOCUMENT);
                var_margin = user.getString(configuration.KEY_MARGIN);
                var_pembulatan = user.getString(configuration.KEY_PEMBULATAN);
                var_unit_condition = user.getString(configuration.KEY_UNIT_CONDITION);
