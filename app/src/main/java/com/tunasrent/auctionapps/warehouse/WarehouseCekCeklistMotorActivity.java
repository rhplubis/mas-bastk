...
public class WarehouseCekCeklistMotorActivity extends AppCompatActivity {
    Toolbar toolbar;
    Button btnNext;
    ...
    //    # BODY #
    CheckBox cbcover_kepala1, cbcover_kepala2;
...
//    EditText etMerk_listrik;
    ...
    Boolean var_cover_kepala1=false;
    Boolean var_cover_kepala2=false;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_warehouse_cek_ceklist_motor);
        ...
        cbcover_kepala1 = findViewById(R.id.cb_cover_kepala1);
        cbcover_kepala2 = findViewById(R.id.cb_cover_kepala2);
...
//        # PERLENGKAPAN #
        ...
        if (b != null){
            ...
            var_cover_kepala1 = (b.getInt("cover_kepala1") == 0) ? false : true;
            var_cover_kepala2 = (b.getInt("cover_kepala2") == 0) ? false : true;

            if (var_cover_kepala1 != null) {
                String coverKPL1Value = String.valueOf(var_cover_kepala1);
                Log.d("Cover KPL 1", coverKPL1Value);
            } else {
                Log.e("Cover KPL 1", "Cover KPL 1 is null");
            }

            if (var_cover_kepala2 != null) {
                String coverKPL2Value = String.valueOf(var_cover_kepala1);
            } else {
                Log.e("Cover KPL 2", "Cover KPL 2 is null");
            }
...
//        Toast.makeText(TaksasiCekCeklistActivity.this,var_picPengiriman,Toast.LENGTH_SHORT).show();
        ...
        cbcover_kepala1.setChecked(var_cover_kepala1);
        cbcover_kepala1.setText((var_cover_kepala1 == true) ? "Ada" : "Tidak Ada");
        cbcover_kepala2.setChecked((var_cover_kepala1 == true) ? var_cover_kepala2 : false);
        cbcover_kepala2.setVisibility((var_cover_kepala1 == true) ? View.VISIBLE : View.INVISIBLE);
        cbcover_kepala2.setText((var_cover_kepala2 == true) ? "Baik" : "Rusak");
        ...
        btnNext.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent i = new Intent(WarehouseCekCeklistMotorActivity.this,WarehouseCekFotoActivity.class);
                Bundle b = new Bundle();
