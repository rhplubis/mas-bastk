...
public class WarehouseCekCeklistActivity extends AppCompatActivity {
    Toolbar toolbar;
    Button btnNext;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_warehouse_cek_ceklist);
...
//            var_etStnk = b.getString("stnk_lain");
            ...
            if(b.getString("stnk_lain").equals("null")){
...
//        cbDopBlk2_fisikkanan.setText((var_cbDop2_fisikkiri == true) ? "Baik" : "Rusak");
        ...
        btnNext.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent i = new Intent(WarehouseCekCeklistActivity.this, WarehouseCekFotoActivity.class);
                Bundle b = new Bundle();
