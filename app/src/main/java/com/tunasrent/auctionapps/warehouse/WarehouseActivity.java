...
import com.tunasrent.auctionapps.model.WarehouseList;
import com.tunasrent.auctionapps.model.WarehouseListAdapter;
...
public class WarehouseActivity extends AppCompatActivity {
    ...
    private ArrayList<WarehouseList> item_list = new ArrayList<>();
...
//                loading.dismiss();
            ...
            protected String doInBackground(Void... params) {
                ...
                hashMap.put(configuration.KEY_PARENT,"3");
...
//            result = jsonObject.getJSONArray(configuration.TAG_JSON_DATA);
        ...
        if (code.equals("200")) {
            for (int i=0;i < result.length(); i++) {
                ...
                WarehouseList warehouseList = new WarehouseList(vhcdate,vhcid,vhctype,vendor,status,by);
                item_list.add(warehouseList);
                ...
                mAdapter = new WarehouseListAdapter(item_list);
            ...
            Toast.makeText(WarehouseActivity.this,message,Toast.LENGTH_SHORT).show();
...
//                return true;
                ...
                ArrayList<WarehouseList> newList  = new ArrayList<>();
                for (WarehouseList warehouseList : item_list){
                    String name = warehouseList.getNopol().toLowerCase();
                    String type = warehouseList.getVendor().toLowerCase();
                    if (name.contains(newText)) {
                        newList.add(warehouseList);
