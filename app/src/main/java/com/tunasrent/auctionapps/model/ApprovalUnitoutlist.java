...
public class ApprovalUnitoutlist implements Serializable {
...
//    String bar;
    ...
    public ApprovalUnitoutlist(String vhcid, String vhctype, String vhccolor, String vhcyear, String vendor, String status , String procby , String type_aset, String jenisunit){
        this.vhcid = vhcid ;
