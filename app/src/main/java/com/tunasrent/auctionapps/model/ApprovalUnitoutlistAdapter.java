...
import com.tunasrent.auctionapps.approvalunitout.ApprovalUnitoutCekFormActivity;
//import com.tunasrent.auctionapps.unitout.UnitoutCekFormActivity;

import java.util.ArrayList;

public class ApprovalUnitoutlistAdapter extends RecyclerView.Adapter<ApprovalUnitoutlistAdapter.ViewHolder> {
    public ArrayList<ApprovalUnitoutlist> item_list;
    public ApprovalUnitoutlistAdapter(ArrayList<ApprovalUnitoutlist> arrayList) {
        item_list = arrayList;
    }
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int i) {
        ...
        ApprovalUnitoutlistAdapter.ViewHolder viewHolder = new ApprovalUnitoutlistAdapter.ViewHolder(view);
...
//        holder.date.setText(sub[0]);
        ...
        ApprovalUnitoutlist item = item_list.get(currentPosition);
...
//        holder.vendor.setText(item_list.get(position).getVendor());
        ...
        holder.container.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent i = new Intent(v.getContext(), ApprovalUnitoutCekFormActivity.class);
                Bundle b = new Bundle();
    ...
    public void setFilter(ArrayList<ApprovalUnitoutlist> newList) {
