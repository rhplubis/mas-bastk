...
import com.tunasrent.auctionapps.bp.BpCekFotoActivity;
...
public class TaksasiCekCeklistActivity extends AppCompatActivity {
    Toolbar toolbar;
    Button btnNext;
...
//        cbDopBlk2_fisikkanan.setText((var_cbDop2_fisikkiri == true) ? "Baik" : "Rusak");
        ...
        btnNext.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent i = new Intent(TaksasiCekCeklistActivity.this,TaksasiCekFotoActivity.class);
                Bundle b = new Bundle();
