...
public class MobCekBastkCeklistActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_mob_cek_bastk_ceklist);
...
//        getSupportActionBar().setTitle("Ceklist Unit");
        ...
        layoutCek = findViewById(R.id.layout_cek);
    ...
    private void sendUpdate(){
        class SendUpdate extends AsyncTask<Void,Void,String> {
            ...
            protected void onPreExecute() {
                super.onPreExecute();
                loading = ProgressDialog.show(MobCekBastkCeklistActivity.this,"","Updating...",false,false);
            }
            @Override
            ...
            protected String doInBackground(Void... params) {
                ...
                hashMap.put(configuration.KEY_KODE,"MOB");
...
//                    Toast.makeText(DisCekBastkCeklistActivity.this,"params : " + dikirim,Toast.LENGTH_LONG).show();
    ...
    private void showUpdate(String json){
        try {
            ...
            if(code == 200){
                Toast.makeText(MobCekBastkCeklistActivity.this,"Update Sukses",Toast.LENGTH_LONG).show();
                ShowPopupPdf();

//                Intent i=new Intent(MobCekBastkCeklistActivity.this, MainActivity.class);
...
//        web_view.getSettings().setLoadWithOverviewMode(false);
    ...
    private void getBastk(){
        class GetBastk extends AsyncTask<Void,Void,String> {
            ...
            protected void onPreExecute() {
                super.onPreExecute();
                loading = ProgressDialog.show(MobCekBastkCeklistActivity.this,"","Loading...",false,false);
            }
            @Override
            protected void onPostExecute(String s) {
                super.onPostExecute(s);
            ...
            protected String doInBackground(Void... params) {
                ...
                hashMap.put(configuration.KEY_TOKEN,_token);
                hashMap.put(configuration.KEY_VEHICLEID,nopol);
                hashMap.put(configuration.KEY_MODE,"2");
    ...
    private void showData(String json){
        try {
            ...
            if(code == 200){
                Toast.makeText(MobCekBastkCeklistActivity.this,"Masuk",Toast.LENGTH_LONG).show();
...
//                            Toast.makeText(DisCekBastkCeklistActivity.this,"deskripsi index : " + nama,Toast.LENGTH_SHORT).show();
            ...
            layoutCek.setVisibility(View.GONE);
            adaEdit = 0;
            Toast.makeText(MobCekBastkCeklistActivity.this,"error",Toast.LENGTH_LONG).show();
        }
