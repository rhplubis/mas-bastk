...
public class MobInputSignActivity extends AppCompatActivity implements AsyncTaskCompleteListener {
...
//    String picPenjualan;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_mob_input_sign);
...
//                DatePickerDialog dpd_start = new DatePickerDialog(MobInputSignActivity.this, datestart, myCalendar.get(Calendar.YEAR),
...
//            @Override
//            public void onClick(View v) {
//                DatePickerDialog dpd_end = new DatePickerDialog(MobInputSignActivity.this, dateend, myCalendar.get(Calendar.YEAR),
//                        myCalendar.get(Calendar.MONTH), myCalendar.get(Calendar.DAY_OF_MONTH));
...
//                    Toast.makeText(MobInputSignActivity.this,"Tanggal wajib diisi.",Toast.LENGTH_LONG).show();
//                }else if (etPembiayaan.getText().toString().equals("")){
//                    Toast.makeText(MobInputSignActivity.this,"No Pembiayaan wajib diisi.",Toast.LENGTH_LONG).show();
                if (ivPicpenyimpanan.getDrawable() == null){
                    Toast.makeText(MobInputSignActivity.this,"Tanda tangan wajib diisi.",Toast.LENGTH_LONG).show();
                }else {
...
//        final String tglakhir = tgl2[2] + "-" + tgl2[1] + "-" + tgl2[0];
        ...
        class SendData extends AsyncTask<Void,Void,String> {
            ...
            protected void onPreExecute() {
                super.onPreExecute();
                loading = ProgressDialog.show(MobInputSignActivity.this,"","Processing...",false,false);
            }
            @Override
            ...
            protected String doInBackground(Void... params) {
                ...
                hashMap.put(configuration.KEY_STATUS,"5");
...
//                realm.commitTransaction();
                Toast.makeText(MobInputSignActivity.this,"Data Berhasil Di Input",Toast.LENGTH_SHORT).show();

                Intent i=new Intent(MobInputSignActivity.this, MainActivity.class);
                i.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
                startActivity(i);
            } catch (Exception ex){
                ex.printStackTrace();
                Toast.makeText(MobInputSignActivity.this,"Data Gagal Di Input",Toast.LENGTH_SHORT).show();
            }
...
//        final String nop = nop1 + "-" + nop2 + "-" + nop3;
        class GetFoto extends AsyncTask<Void,Void,String> {
            ...
            protected void onPreExecute() {
                super.onPreExecute();
                loading = ProgressDialog.show(MobInputSignActivity.this,"","Loading sign...",false,false);
            }
            @Override
            protected void onPostExecute(String s) {
                super.onPostExecute(s);
...
//        String nop = nop1 + "-" + nop2 + "-" + nop3;
        try {
            if (!YuliYanto.isNetworkAvailable(MobInputSignActivity.this)) {
                Toast.makeText(MobInputSignActivity.this, "Internet is required!", Toast.LENGTH_SHORT).show();
                return;
            }
            ...
            Toast.makeText(MobInputSignActivity.this,"Please check permission storage",Toast.LENGTH_SHORT).show();
            directSetting();
            //e.printStackTrace();
        }
    }
...
//            Toast.makeText(MobInputSignActivity.this,response.toString(),Toast.LENGTH_LONG).show();
            try {
            ...
            if (code.equals("200")) {
                File dir = new File(Environment.getExternalStorageDirectory() + IMAGE_DIRECTORY);
                FileUtils.deleteDirectory(dir);
                //Toast.makeText(MobInputSignActivity.this,"Sukses",Toast.LENGTH_SHORT).show();
...
//                    Glide.with(this).load(picPenjualan).into(ivPicpenjualan);
                ...
                Toast.makeText(MobInputSignActivity.this,message,Toast.LENGTH_SHORT).show();
            }else {
                Toast.makeText(MobInputSignActivity.this,message,Toast.LENGTH_SHORT).show();
            }
    ...
    public void ShowPopupKonsumen(View v) {
        ...
        mSignaturePad.setOnSignedListener(new SignaturePad.OnSignedListener() {
            ...
            public void onStartSigning() {
                //Toast.makeText(MobInputSignActivity.this, "OnStartSigning", Toast.LENGTH_SHORT).show();
            }
...
//                String path = saveImage(thumbnail);
                ...
                Toast.makeText(MobInputSignActivity.this,paths,Toast.LENGTH_LONG).show();
...
//                    Toast.makeText(MobInputSignActivity.this, "Signature saved into the Gallery", Toast.LENGTH_SHORT).show();
//                } else {
//                    Toast.makeText(MobInputSignActivity.this, "Unable to store the signature", Toast.LENGTH_SHORT).show();
//                }
//                if (addSvgSignatureToGallery(mSignaturePad.getSignatureSvg())) {
//                    Toast.makeText(MobInputSignActivity.this, "SVG Signature saved into the Gallery", Toast.LENGTH_SHORT).show();
//                } else {
//                    Toast.makeText(MobInputSignActivity.this, "Unable to store the SVG signature", Toast.LENGTH_SHORT).show();
//                }
            }
        });
        ...
        switch (requestCode) {
            case REQUEST_EXTERNAL_STORAGE: {
                ...
                if (grantResults.length <= 0
                    ...
                    Toast.makeText(MobInputSignActivity.this, "Cannot write images to external storage", Toast.LENGTH_SHORT).show();
                }
            }
        }
    }
    ...
    private void scanMediaFile(File photo) {
        ...
        MobInputSignActivity.this.sendBroadcast(mediaScanIntent);
    }
