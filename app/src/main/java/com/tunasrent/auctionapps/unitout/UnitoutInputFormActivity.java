...
import com.tunasrent.auctionapps.mobilisasi.MobInputCeklistActivity;
import com.tunasrent.auctionapps.mobilisasi.MobInputCeklistMotorActivity;
...
public class UnitoutInputFormActivity extends AppCompatActivity {
...
//    private String[] type_mtr = {"RODA 2"};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_unitout_input_form);
...
//        etMeterbensin = findViewById(R.id.et_meterbensin);
        ...
        Log.d("ini data nopolnya = ",var_nopol);
        ...
        if (!results.isEmpty()){
            ...
            spType.setText(results.first().getType());
...
//                Intent i = new Intent(UnitoutInputFormActivity.this, .class);
//                startActivity(i);
//                overridePendingTransition(R.anim.slide_in_right, R.anim.slide_out_left);
        ...
        etTanggal.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                DatePickerDialog dpd_start = new DatePickerDialog(UnitoutInputFormActivity.this, datestart, myCalendar.get(Calendar.YEAR),
        ...
        etPukul.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                TimePickerDialog timePickerDialog = new TimePickerDialog(UnitoutInputFormActivity.this,
...
//                    String poolName = jo.getString(configuration.KEY_POOL_NAME);
                ...
                Toast.makeText(UnitoutInputFormActivity.this, "Data Not Found, " + message, Toast.LENGTH_SHORT).show();
            }
        } catch (JSONException e) {
            //e.printStackTrace();
            Toast.makeText(UnitoutInputFormActivity.this,"Please Check Your Connection",Toast.LENGTH_SHORT).show();
        }
...
//                spType .setText(vhc_cat_name);
    ...
    private void sendForm(){
        ...
        class SendData extends AsyncTask<Void,Void,String> {
            ...
            protected void onPreExecute() {
                super.onPreExecute();
                loading = ProgressDialog.show(UnitoutInputFormActivity.this,"","Processing...",false,false);
            }
            @Override
            protected void onPostExecute(String s) {
                super.onPostExecute(s);
            ...
            protected String doInBackground(Void... params) {
                ...
                hashMap.put(configuration.KEY_TYPE_MOBILISASI,spTypeMobilisasi.getText().toString());
                ...
                hashMap.put(configuration.KEY_TYPE, spType.getText().toString());
...
//                hashMap.put(configuration.KEY_meterbensin,etMeterbensin.getText().toString());
    ...
    private void showForm(String json){
        try {
            ...
            if(code == 200 ){
                if(jenis.equals("RODA 2")){
                    //Intent i = new Intent(UnitoutInputFormActivity.this, MobInputCeklistMotorActivity.class);
                    Bundle b = new Bundle();
                   ...
                   // Intent i = new Intent(UnitoutInputFormActivity.this, MobInputCeklistActivity.class);
                    Bundle b = new Bundle();
                    b.putString("parse_nopol",var_nopol);
                   // i.putExtras(b);
                    //startActivity(i);
