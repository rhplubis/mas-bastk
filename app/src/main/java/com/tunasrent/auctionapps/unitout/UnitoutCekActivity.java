...
public class UnitoutCekActivity extends AppCompatActivity {
...
//        etMeterbensin = findViewById(R.id.et_meterbensin);
        ...
        btnNext.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                //Intent i = new Intent(UnitoutCekActivity.this, .class);
                //startActivity(i);
        ...
        etTanggal.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                DatePickerDialog dpd_start = new DatePickerDialog(UnitoutCekActivity.this, datestart, myCalendar.get(Calendar.YEAR),
        ...
        etPukul.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                TimePickerDialog timePickerDialog = new TimePickerDialog(UnitoutCekActivity.this,
...
//                    String poolName = jo.getString(configuration.KEY_POOL_NAME);
                ...
                Toast.makeText(UnitoutCekActivity.this, "Data Not Found, " + message, Toast.LENGTH_SHORT).show();
            }
        } catch (JSONException e) {
            //e.printStackTrace();
            Toast.makeText(UnitoutCekActivity.this,"Please Check Your Connection",Toast.LENGTH_SHORT).show();
        }
...
//                spType .setText(vhc_cat_name);
    ...
    private void sendForm(){
        ...
        class SendData extends AsyncTask<Void,Void,String> {
            ...
            protected void onPreExecute() {
                super.onPreExecute();
                loading = ProgressDialog.show(UnitoutCekActivity.this,"","Processing...",false,false);
            }
            @Override
            protected void onPostExecute(String s) {
                super.onPostExecute(s);
