...
public class UnitoutCekFormActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_unitout_cek_form);
        ...
        btnNext.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(vhc_cat_name.equals("MTR")) {
                    Intent i = new Intent(UnitoutCekFormActivity.this, UnitoutCekCeklistMotorActivity.class);
                    Bundle b = new Bundle();
                    ...
                    Intent i = new Intent(UnitoutCekFormActivity.this, UnitoutCekCeklistActivity.class);
                    Bundle b = new Bundle();
    ...
    private void getBastk(){
        class GetBastk extends AsyncTask<Void,Void,String> {
            ...
            protected void onPreExecute() {
                super.onPreExecute();
                loading = ProgressDialog.show(UnitoutCekFormActivity.this,"","Loading...",false,false);
            }
            @Override
            ...
            protected String doInBackground(Void... params) {
                ...
                hashMap.put(configuration.KEY_PARENT,"6");
