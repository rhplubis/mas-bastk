...
//import com.tunasrent.auctionapps.unitout.UnitoutCekFotoActivity;
import com.tunasrent.auctionapps.util.UserSessionManager;
import com.tunasrent.auctionapps.util.configuration;

import java.util.HashMap;

public class UnitoutCekCeklistActivity extends AppCompatActivity {
    Toolbar toolbar;
    Button btnNext;
...
//        cbDopBlk2_fisikkanan.setText((var_cbDop2_fisikkiri == true) ? "Baik" : "Rusak");
        ...
        btnNext.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View v){
                Intent i = new Intent(UnitoutCekCeklistActivity.this, UnitoutReasonReturnActivity.class);
                Bundle b = new Bundle();
                ...
                Log.wtf("nopol yang diterima = ", nopol);
                i.putExtras(b);
                startActivity(i);
    ...
    private void showAlertAndRedirect(String message) {
        new AlertDialog.Builder(UnitoutCekCeklistActivity.this)
                .setTitle("Error")
                .setMessage(message)
                ...
                .setPositiveButton("OK", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        Intent intent = new Intent(UnitoutCekCeklistActivity.this, MainActivity.class);
