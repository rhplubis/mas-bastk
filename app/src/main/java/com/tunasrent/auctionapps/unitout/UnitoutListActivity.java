...
public class UnitoutListActivity extends AppCompatActivity implements AdapterView.OnItemClickListener {
    ...
    private ArrayList<Unitoutlist> item_list = new ArrayList<>();
    private UnitoutlistAdapter mAdapter;
        ...
        try {
            if (code.equals("200")) {
                for (int i = 0; i < result.length(); i++) {
                    ...
                    mAdapter = new UnitoutlistAdapter(item_list);
                    rvDetail.setAdapter(mAdapter);
                    rvDetail.getAdapter().notifyDataSetChanged();
                }

            } else if (code.equals("304")) {
                Toast.makeText(UnitoutListActivity.this, message, Toast.LENGTH_SHORT).show();

                Intent intent = new Intent(UnitoutListActivity.this, LoginActivity.class);
