...
public class UnitoutCekCeklistMotorActivity extends AppCompatActivity {
    Toolbar toolbar;
    Button btnNext;
...
//    EditText etMerk_listrik;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_unitout_cek_ceklist_motor);
...
//        Toast.makeText(TaksasiCekCeklistActivity.this,var_picPengiriman,Toast.LENGTH_SHORT).show();
        ...
        btnNext.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent i = new Intent(UnitoutCekCeklistMotorActivity.this, UnitoutReasonReturnActivity.class);
                Bundle b = new Bundle();
